...
# do not think this program wil be of much use to use. this code focuses on makeing/editing maps
class EditState(FSM.FSM):
    ...
    # disallows user from dragging hieght
    ...
    # allows user to move ground pieces
    ...
    # disallows user from moving ground pieces
    ...
    def init_buttons(self):
        ...
        material_buttons = [
            ...
            DirectRadioButton(text='Stone', variable=material,
                              ...
                              command=set_material),
            #TODO: check
            DirectRadioButton(text='Objective', variable=material,
                              value=['objective'], scale=0.05, pos=(0.5, 0, -0.9),
                              command=set_material),
            DirectRadioButton(text='Obstacle', variable=material,
                              value=['obstacle'], scale=0.05, pos=(0.5, 0, -0.6),
                              command=set_material),
